 ...
 * &lt;i&gt;l3-device-impl/modules/module/configuration/(urn:onos:yangpromotion:impl:l3device?revision=2015-10-01)l3dev-impl/core-service&lt;/i&gt;
 *
 * &lt;p&gt;To create instances of this class use {@link org.onos.yang.gen.v1.urn.onos.yangpromotion.impl.l3device.rev151001.modules.module.configuration.l3dev.impl.CoreServiceBuilder}.
 * @see org.onos.yang.gen.v1.urn.onos.yangpromotion.impl.l3device.rev151001.modules.module.configuration.l3dev.impl.CoreServiceBuilder
 *
 */
public interface CoreService
    extends
    ChildOf<Module>,
    Augmentable<org.onos.yang.gen.v1.urn.onos.yangpromotion.impl.l3device.rev151001.modules.module.configuration.l3dev.impl.CoreService>,
    ServiceRef
{
